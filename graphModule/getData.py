...
def getsweetfavor(wineInfo, starPoint):
    favor = 0
    for i in range(0, len(starPoint)):
        favor =+ wineInfo[i][2] + starPoint[0]

    return favor/len(starPoint)*5

def getacidicfavor(wineInfo, starPoint):
    favor = 0
    for i in range(0, len(starPoint)):
        favor =+ wineInfo[i][3] + starPoint[1]
...
def getbodyfavor(wineInfo, starPoint):
    favor = 0
    for i in range(0, len(starPoint)):
        favor =+ wineInfo[i][4] + starPoint[2]
...
def gettanninfavor(wineInfo, starPoint):
    favor = 0
    for i in range(0, len(starPoint)):
        favor =+ wineInfo[i][5] + starPoint[3]
